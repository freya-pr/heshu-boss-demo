...
const seed: DemoDb = {
  ...
  employees: [
    { id: 1, employee_no: 'B000001', name: '李士文', legal_name: '李士文', mobile_masked: '138****1201', email: 'lishiwen@heshu.com', organization_id: 2, position_name: '部门负责人', wecom_user_id: 'wx_lishiwen', legacy_feishu_employee_no: 'FS10001', employment_status: 'ACTIVE', account_status: 'ACTIVE', load: 18, assignment_limit: 30, qr_camp_name: '2026暑期第3营' },
    { id: 2, employee_no: 'B000126', name: '王老师', legal_name: '王琴', mobile_masked: '139****4508', email: 'wangqin@heshu.com', organization_id: 3, position_name: '课程顾问', wecom_user_id: 'wx_wang', legacy_feishu_employee_no: 'FS10002', employment_status: 'ACTIVE', account_status: 'ACTIVE', load: 12, assignment_limit: 20, qr_camp_name: '2026暑期第3营' },
    { id: 3, employee_no: 'B000135', name: '陈老师', legal_name: '陈晨', mobile_masked: '136****8821', email: 'chenchen@heshu.com', organization_id: 9, position_name: '课程顾问', wecom_user_id: 'wx_chen', legacy_feishu_employee_no: 'FS10003', employment_status: 'ACTIVE', account_status: 'ACTIVE', load: 16, assignment_limit: 18, qr_camp_name: '2026暑期第3营' },
    { id: 4, employee_no: 'B000208', name: '刘老师', legal_name: '刘子云', mobile_masked: '157****5728', email: 'liuziyun@heshu.com', organization_id: 5, position_name: '客服专员', wecom_user_id: 'wx_liu', legacy_feishu_employee_no: 'FS10004', employment_status: 'ACTIVE', account_status: 'ACTIVE', load: 9, assignment_limit: 15, qr_camp_name: '2026暑期第3营' },
    { id: 5, employee_no: 'B000281', name: '吴老师', legal_name: '吴若燕', mobile_masked: '136****0104', email: 'wuruoyan@heshu.com', organization_id: 6, position_name: '运营专员', wecom_user_id: '', legacy_feishu_employee_no: 'FS10005', employment_status: 'ACTIVE', account_status: 'ACTIVE', load: 7, assignment_limit: 10, qr_camp_name: '' },
    { id: 6, employee_no: 'B000293', name: '李经理', legal_name: '李景', mobile_masked: '136****8265', email: 'lijing@heshu.com', organization_id: 7, position_name: '财务经理', wecom_user_id: 'wx_lijing', legacy_feishu_employee_no: 'FS10006', employment_status: 'ACTIVE', account_status: 'ACTIVE', load: 3, assignment_limit: 8, qr_camp_name: '' },
    { id: 7, employee_no: 'B000297', name: '赵主管', legal_name: '赵梅', mobile_masked: '183****9828', email: 'zhaomei@heshu.com', organization_id: 8, position_name: '人事主管', wecom_user_id: 'wx_zhao', legacy_feishu_employee_no: '', employment_status: 'ACTIVE', account_status: 'INACTIVE', load: 0, assignment_limit: 0, qr_camp_name: '' }
  ]
}
...
function normalizeDb(source: DemoDb): DemoDb {
  source.employees.forEach(item=>{item.employee_no=normalizeEmployeeNo(item.employee_no);if(item.feishu_user_id&&!item.legacy_feishu_employee_no)item.legacy_feishu_employee_no=item.feishu_user_id;delete item.feishu_user_id})
