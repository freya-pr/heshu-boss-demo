...
export const demoHttp = {
  async get(path: string, config: any = {}) {
    ...
    if (path === '/auth/bindings') return ok([
      { id: 1, platform: '企业微信', identifier: 'wx_linxiaozhang_01', nickname: '林校长 · 集团管理中心' },
      { id: 2, platform: '企业微信', identifier: 'wx_linxiaozhang_02', nickname: '林校长 · 教研协同号' }
    ])
