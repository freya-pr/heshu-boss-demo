...
flowchart TB
    ...
    ANALYTICS --> REPORT["当前营期经营报表条"]
    ANALYTICS --> JOURNEY["线索转化旅程"]
    JOURNEY --> DRILL["点击关键指标：打开明细抽屉"]
    ANALYTICS --> MATRIX["过程效率 / 结果质量 / 经营效能"]
    ANALYTICS --> FINANCE["GMV与退款经营卡片"]
...
| 页面区域 | V1.0内容 |
|---|---|
| 线索概览 | 以当前所选营期为主体展示卡片式经营看板；集中展示转化旅程、过程与结果指标、GMV与退款、渠道、IP渠道、商品及成交趋势，支持指标下钻、分区导出和当前营期完整报表导出 |
...
| 3 | 当前营期报表条 | 展示营期名称、统计日期、数据版本、更新时间及“导出本期完整报表”入口 |
| 4 | 线索转化旅程 | 按有效线索、加微、问卷、预约、到课、完课、成交展示阶段人数和环节转化率，并补充当前在线、退款等结果信号 |
| 5 | 经营指标区 | 左侧按过程效率、结果质量、经营效能展示指标卡，右侧展示毛GMV、退款金额、净GMV和目标完成率 |
...
| 10 | 指标明细抽屉 | 点击关键人数打开，不离开当前页面；展示订单、客户、来源、店铺、商品、IP归因、负责人和事件时间 |
...
- [ ] 当前营期以卡片式经营看板展示，并完整覆盖有效线索、加微、问卷、预约、到课、完课、成交、退款、GMV和人服比；
- [ ] 转化旅程、经营指标、GMV与退款、渠道分析、IP渠道分析、商品分析和成交趋势均独立成区且信息层级清晰；
...
- [ ] 明细抽屉中的订单、客户、渠道、店铺、商品、IP和负责人可以进入对应业务页面，并携带正确的稳定编号；
...
- [ ] 1366×768分辨率下筛选和卡片式经营看板正常使用，分析表格仅在自身容器内横向滚动且不遮挡页面导航。

## 9. 发布与回滚

- 线索概览按转化旅程、指标卡片、渠道、IP渠道、商品、趋势和下钻明细分别配置功能开关；
- 新指标异常时隐藏对应指标卡片或分析列，不影响其他看板模块；
