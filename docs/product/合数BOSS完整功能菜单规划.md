...
flowchart LR
    ...
    subgraph SUPPORTBOX["业务域八｜平台支撑中心｜阶段一重点"]
        direction TB
        BUSINESS_BASE["业务配置｜短信管理 · V1.0<br/>企微管理 · V1.0<br/>百家号配置 · V2.0<br/>审计管理｜异常中心 · V1.0<br/>发送结果 · V1.0"]
...
| 审计管理 | 发送结果 | 短信任务与供应商回执 | 结果、错误码、计费、重试及补发节点 | V1.0 |
