...
| 活码管理 | 按企业微信主体、活码分组、企微/内部标签和期次配置多人接待，承接新旧活码及扫码/加微事件 | 分组筛选、新增、编辑、启停、列表下载、排班人员与接量权重、全天在线兜底、创建人、查看效果 | V1.0 |
...
| 线索中心 | 活码管理 | 新旧员工活码、分组、IP归因、标签及多人接待配置 | 分组筛选、新增、编辑、启停、列表下载、关联IP、排班规则、规则内员工与接量权重、全天在线兜底、创建人及双类标签 | V1.0 |
