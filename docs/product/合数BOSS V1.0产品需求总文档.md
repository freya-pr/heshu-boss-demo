...
| 客户中心 | 客户列表 | 唯一客户档案 | 字段设置仅展示齿轮图标并固定客户编号/客户名称/操作；生命周期和系统/企微标签筛选；手机号授权预览与变更；基本档案、线索、问卷及时间轴；企微客户全量/增量同步 | V1.0 |
| 客户中心 | 撞单管理 | 手机号与 UnionID 跨档案命中的强身份冲突处理 | 自动建案、幂等阻断、领取处理、双档案证据对比、指定主档合并、确认不同人、审计与反向恢复；不展示风险统计、筛选和等级 | V1.0 |
...
| 客户列表 | 固定客户编号、客户名称和操作列；字段设置仅展示齿轮图标；支持生命周期、系统/企微标签、手机号预览/变更、基本档案、线索、问卷、时间轴及企微客户同步 |
| 撞单管理（V1.0） | 手机号与 UnionID 分别命中不同客户时自动建案，支持双档案证据核验、指定主档合并、确认不同人、完整审计与反向恢复；页面仅按处理状态管理，不展示风险状态相关内容 |
