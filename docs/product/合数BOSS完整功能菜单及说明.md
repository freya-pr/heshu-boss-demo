...
| 线索中心 | IP管理 | IP大类、IP渠道、IP名称及稳定编码 | 按IP大类、IP渠道、IP名称展示和配置，支持新增、编辑、启停及筛选 | V1.0 |
| 线索中心 | 商品列表 | 第三方商品与店铺、活码、IP的关联主档 | 创建/更新时间、商品名称、商品ID、状态、是否分配活码、店铺名称/类型、关联IP、同步所有商品、分平台顺序同步、任务记录、导出、修改备注 | V1.0 |
| 线索中心 | 短信配置 | 商品与活码维度的业务短信提醒策略 | 短信分组、商品/活码绑定、购买后提醒、授权后提醒、手动提醒、下单未加微补发、批量设置、新增、编辑、启停 | V1.0 |
...
| 个人中心 | 用户信息 | 当前登录用户的个人资料与账号安全设置 | 基本设置、密码设置、外部绑定；一个账号允许绑定多个企业微信身份 | V1.0 |
| 个人中心 | 我的下载 | 导出任务、生成进度及下载记录 | 服务人、部门、申请人/文件名称、申请时间、状态筛选、刷新、下载；记录列表展示下载时间、文件、下载人和状态，不展示下载IP | V1.0 |
...
| 业务配置 | 短信管理 | 复用历史短信服务并按抖店配置发送规则 | 运营商管理、签名管理、短信模板、短信规则、支付后3分钟/下单后8分钟未加微补发 | V1.0 |
