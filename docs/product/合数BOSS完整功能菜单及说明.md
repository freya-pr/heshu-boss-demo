...
| 线索中心 | IP管理 | 按IP大类、IP渠道、IP名称维护老师IP主档 | IP编号和大类编码稳定展示；移除当前IP、IP配置、关联商品/平台；新增、编辑、启停 | V1.0 |
| 线索中心 | 商品列表 | 第三方商品与店铺、活码关联主档 | 创建/更新时间、商品名称、商品ID、状态、是否分配活码、店铺名称/类型、同步、任务记录、导出、备注；移除关联IP | V1.0 |
