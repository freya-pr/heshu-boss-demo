...
| 客户中心 | 企微标签 | 管理企业微信标签分组及标签 | 支持分组搜索、新增、编辑、删除和空分组批量删除；支持单个/批量新增标签、编辑、删除、全局搜索及使用客户下钻；不展示“系统”来源 | V1.0 |
...
| 企微标签 | 左侧维护企业微信标签分组，右侧维护当前分组标签；支持分组搜索、新增、编辑、删除及空分组批量删除；支持单个/批量新增标签、编辑、删除、全局搜索和使用客户下钻；标签来源不展示“系统” |
