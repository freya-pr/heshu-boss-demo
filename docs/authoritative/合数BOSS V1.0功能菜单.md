...
| 线索中心 | 活码管理 | 活码分组、新旧活码、关联IP并自动带出IP渠道、企微/内部标签、排班人员与接量权重、创建人和效果；统一多人接待，无备用员工及接量日期 | P0 |
| 线索中心 | 渠道管理 | 渠道列表维护基础信息、归因和状态；数据分析页签展示渠道线索到客户及成交转化 | P1 |
| 线索中心 | 店铺管理 | 店铺档案、负责人、权限、线索/加微、订单/支付、净GMV、经营详情和归因异常 | P1 |
| 线索中心 | IP管理 | 按IP大类、IP渠道、IP名称顺序维护IP主数据；不关联商品或平台 | P1 |
...
| 客户中心 | 企微标签 | 按分组维护企微企业标签，支持适用部门多选、批量新增、编辑、删除及同步企微 | P1 |
...
| 审计管理 | 发送结果 | 短信回执、送达结果与失败信息查询 | P1 |
| 业务配置 | 短信管理 | 签名管理、短信模板、短信规则、下单未加微补发和发送结果 | P1 |
| 业务配置 | 企微管理 | 企微、小程序、落地页和微信客服配置；应用管理从企微配置行内进入 | P1 |
