...
| 客户中心 | 企微标签 | 按企业微信标签组维护企微企业标签 | 标签分组、适用部门多选、批量新增、编辑、删除、同步企微 | V1.0 |
...
| 业务配置 | 短信管理 | 复用历史短信服务并按抖店配置发送规则 | 运营商管理、签名管理、短信模板、短信规则 | V1.0 |
...
| 企微标签 | 仅管理企微企业标签；支持分组适用部门多选、批量新增及同步 | V1.0 |
### 4.4 订单数据能力（非菜单）
...
| 二级菜单 | 功能说明 | 版本 |
|---|---|---|
| 短信管理 | 运营商管理、签名管理、短信模板、短信规则；复用历史短信服务 | V1.0 |
...
| 审计管理 | 异常中心 | 企业微信及同步异常 | 查询、详情、重试、忽略、转人工、关闭 | V1.0 |
| 审计管理 | 发送结果 | 短信供应商回执、送达结果与失败信息 | 查询、详情 | V1.0 |
| 业务配置 | 短信管理 | 复用历史短信服务 | 运营商管理、签名管理、短信模板、短信规则 | V1.0 |
| 业务配置 | 应用管理 | 接入合数BOSS的外部应用 | 新增、编辑、启停、连接校验和凭证轮换 | V1.0 |
| 业务配置 | 配置管理 | 企微、小程序、店铺、落地页配置 | 企微/小程序/店铺支持新增；落地页仅支持筛选、预览、编辑、启停和停用后删除；统一支持校验、发布和版本回退 | V1.0 |
